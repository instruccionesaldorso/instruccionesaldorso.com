...
return array (
  ...
  array (
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/base_news/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
      'composerName' => 'base_news',
    ),
    'powermail' => 
    array (
      'state' => 'active',
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/base_powermail/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
      'composerName' => 'base_powermail',
    ),
    'base_cache_manager' => 
    array (
      'composerName' => 'base_cache_manager',
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/base_cache_manager/',
      'suggestions' => 
      array (
      ),
    ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/base_template/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
      'composerName' => 'base_template',
    ),
    'flux' => 
    array (
      'manifestPath' => '',
